...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
        <form id='form' action='http://weiphp.bb/index.php?s=/w16/WeixinCategory/WeixinCategory/edit/mdm/406%7C407.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-category_name '>
			<label class='item-label'><span class='need_flag'>*</span>栏目名称</label>
			<div class='controls'><input type='text' class='text input-large' name='category_name' value='量品'></div></div>
<input type='hidden' name='id' value='19' />
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542002562' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542002562' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542002562' charset='UTF-8'></script> 
  <script type='text/javascript'>
