...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://weiphp.bb/index.php?s=/w16/Feedback/Feedback/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-username '>
			<label class='item-label'>姓名</label>
			<div class='controls'><input type='text' class='text input-large' name='username' value=''></div></div>
<div class='form-item cf toggle-product '>
			<label class='item-label'>关注的产品</label>
			<div class='controls'><div class='check-item'>
						<input type='checkbox' class='regular-checkbox toggle-data' value='0' id='product_0' name='product[]' toggle-data='' checked='checked' />
							<label for='product_0'></label>微商城</div><div class='check-item'>
						<input type='checkbox' class='regular-checkbox toggle-data' value='1' id='product_1' name='product[]' toggle-data=''/>
							<label for='product_1'></label>微社区</div><div class='check-item'>
						<input type='checkbox' class='regular-checkbox toggle-data' value='2' id='product_2' name='product[]' toggle-data=''/>
							<label for='product_2'></label>乐摇</div></div></div>
<div class='form-item cf toggle-from '>
			<label class='item-label'>来源渠道</label>
			<div class='controls'><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='0' id='from_0' name='from' toggle-data='' checked='checked' />
							<label for='from_0'></label>百度搜索来的</div><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='1' id='from_1' name='from' toggle-data=''/>
							<label for='from_1'></label>朋友介绍</div><div class='check-item'>
						<input type='radio' class='regular-radio toggle-data' value='2' id='from_2' name='from' toggle-data=''/>
							<label for='from_2'></label>公众号推送</div></div></div>
<div class='form-item cf toggle-area '>
			<label class='item-label'>你所在地区</label>
			<div class='controls'><select name='area'><option value='0' class='toggle-data' toggle-data='' selected >美国</option><option value='1' class='toggle-data' toggle-data=''>中国</option><option value='2' class='toggle-data' toggle-data=''>巴西</option><option value='3' class='toggle-data' toggle-data=''>日本</option></select></div></div>
<div class='form-item cf toggle-score '>
			<label class='item-label'>打分</label>
			<div class='controls'><input type='number' class='text' name='score' value=''></div></div>
<div class='form-item cf toggle-is_dev '>
			<label class='item-label'>是否是前端开发人员</label>
			<div class='controls'><select name='is_dev'><option value='0' class='toggle-data' toggle-data='' selected >否</option><option value='1' class='toggle-data' toggle-data=''>是</option></select></div></div>
<div class='form-item cf toggle-cTime '>
			<label class='item-label'>反馈时间</label>
			<div class='controls'><input type='datetime' name='cTime' class='text time' value='' placeholder='请选择时间' /></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542000803' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542000803' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542000803' charset='UTF-8'></script> 
  <script type='text/javascript'>
