...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://weiphp.bb/index.php?s=/w16/Test/Test/add/mdm/17%7C352.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-keyword '>
			<label class='item-label'><span class='need_flag'>*</span>关键词</label>
			<div class='controls'><input type='text' class='text input-large' name='keyword' value=''></div></div>
<div class='form-item cf toggle-keyword_type '>
			<label class='item-label'><span class='need_flag'>*</span>关键词匹配类型</label>
			<div class='controls'><select name='keyword_type'><option value='0' class='toggle-data' toggle-data='' selected >完全匹配</option><option value='1' class='toggle-data' toggle-data=''>左边匹配</option><option value='2' class='toggle-data' toggle-data=''>右边匹配</option><option value='3' class='toggle-data' toggle-data=''>模糊匹配</option></select></div></div>
<div class='form-item cf toggle-title '>
			<label class='item-label'><span class='need_flag'>*</span>问卷标题</label>
			<div class='controls'><input type='text' class='text input-large' name='title' value=''></div></div>
<div class='form-item cf toggle-intro '>
			<label class='item-label'><span class='need_flag'>*</span>封面简介</label>
			<div class='controls'><label class='textarea input-large'><textarea name='intro'></textarea></label></div></div>
<div class='form-item cf toggle-cover '>
			<label class='item-label'><span class='need_flag'>*</span>封面图片</label>
			<div class='controls'><div class='controls uploadrow2' data-max='1' title='点击修改图片' rel='cover'>
					<input type='file' id='upload_picture_cover'>
					<input type='hidden' name='cover' id='cover_id_cover' value=''/>
					<div class='upload-img-box'></div></div></div></div>
<div class='form-item cf toggle-finish_tip '>
			<label class='item-label'><span class='need_flag'>*</span>评论语<span class='check-tips'>(详细说明见上面的提示，配置格式：[0-59]不合格)</span></label>
			<div class='controls'><label class='textarea input-large'><textarea name='finish_tip'></textarea></label></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542000702' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542000702' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542000702' charset='UTF-8'></script> 
  <script type='text/javascript'>
