  ...
  <div class="span9 page_message">
    <section id="contents"> 
      <ul class="tab-nav nav">
        <li class="current"><a href="<?php echo U('lists');?>">投票列表</a></li>
      </ul>
        
      <div class="table-bar">
        <div class="fl">
            <div class="tools"> <a class="btn" href="<?php echo addons_url(MODULE_NAME.'://'.CONTROLLER_NAME.'/add');?>">新 增</a>
        ...
        <div class="search-form fr cf">
          ...
          <?php empty($search_key) && isset($model['search_key']) && $search_key=$model['search_key'];empty($search_key) && $search_key='title'; ?>
            <input type="text" name="<?php echo ($search_key); ?>" class="search-input" value="<?php echo I($search_key);?>" placeholder="请输入投票标题">
