        ...
        <form id="form" action="<?php echo ($post_url); ?>" method="post" class="form-horizontal form-center">
        	<ul id="tab" class="tab-pane in">
            	 <li class="form-item cf">
                    ...
                    <div class="controls">
                      <input type="text" class="text input-large" name="keyword" value="<?php echo ((isset($data["keyword"]) && ($data["keyword"] !== ""))?($data["keyword"]):''); ?>">
                    </div>
                  </li>  
                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>投票标题</label>
                    <div class="controls">
                      <input type="text" class="text input-large" name="title" value="<?php echo ((isset($data["title"]) && ($data["title"] !== ""))?($data["title"]):''); ?>">
                    </div>
                  </li>  
                  <li class="form-item cf">
                		...
                		<div class="controls uploadrow2" data-max="1" title="点击修改图片" rel="picurl">
                            ...
                            <input type="hidden" name="picurl" id="cover_id_picurl" value="<?php echo ((isset($data["picurl"]) && ($data["picurl"] !== ""))?($data["picurl"]):''); ?>"/>
                  ...
                  <li class="form-item cf">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="text input-large" name="description" ><?php echo ((isset($data["description"]) && ($data["description"] !== ""))?($data["description"]):''); ?></textarea>
                      </label>
                    </div>
                  </li>   
                  ...
                  <li class="form-item cf">
                    ...
                    <div class="controls">
                       <input type="datetime" name="start_date" class="text input-large time" value="<?php echo (time_format((isset($data["start_date"]) && ($data["start_date"] !== ""))?($data["start_date"]):'')); ?>" placeholder="请选择时间" />
                    </div>
                  </li>  
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>结束时间</label>
                    <div class="controls">
                       <input type="datetime" name="end_date" class="text input-large time" value="<?php echo (time_format((isset($data["end_date"]) && ($data["end_date"] !== ""))?($data["end_date"]):'')); ?>" placeholder="请选择时间" />
                    </div>
                  </li>   
