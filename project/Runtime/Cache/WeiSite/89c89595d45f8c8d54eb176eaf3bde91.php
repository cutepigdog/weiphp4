...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://weiphp.bb/index.php?s=/w16/WeiSite/Footer/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-url '>
			<label class='item-label'>关联URL</label>
			<div class='controls'><input type='text' class='text input-large' name='url' value=''></div></div>
<div class='form-item cf toggle-title '>
			<label class='item-label'><span class='need_flag'>*</span>菜单名<span class='check-tips'>(可创建最多 3 个一级菜单，每个一级菜单下可创建最多 5 个二级菜单。编辑中的菜单不会马上被用户看到，请放心调试。)</span></label>
...
<div class='form-item cf toggle-pid '>
			...
			<div class='controls'><select name='pid'><option value='0' class='toggle-data' toggle-data='' selected >无</option></select></div></div>
...
<div class='form-item cf toggle-icon '>
			<label class='item-label'>图标<span class='check-tips'>(根据选择的底部模板决定是否需要上传图标)</span></label>
			<div class='controls'><div class='controls uploadrow2' data-max='1' title='点击修改图片' rel='icon'>
...
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542000736' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542000736' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542000736' charset='UTF-8'></script> 
  <script type='text/javascript'>
