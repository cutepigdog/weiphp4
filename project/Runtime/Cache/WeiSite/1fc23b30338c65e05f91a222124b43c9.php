...
<div class="span9 page_message">
	<section id="contents">
      <div class="setting_step app_setting content_step" style="margin:20px">
         <a class="step step_cur_1" href="<?php echo addons_url('WeiSite://Template/index',array('mdm'=>I('mdm')));?>">1.选择模板</a>
       	 <a class="step " href="<?php echo addons_url('WeiSite://Slideshow/lists',array('mdm'=>I('mdm')));?>">2.幻灯片配置</a>
         <a class="step " href="<?php echo addons_url('WeiSite://Category/lists',array('mdm'=>I('mdm')));?>">3.栏目配置</a> 
         <a class="step " href="<?php echo addons_url('WeiSite://WeiSite/preview',array('mdm'=>I('mdm')));?>">4.效果预览</a>
  </div>
			...
			if(!$(this).hasClass('selected')){
				...
				$.ajax({
					...
					success:function(data){ 
					    window.location.href = "<?php echo ($next_url); ?>&mdm=<?php echo I('mdm');?>"; }
					})
				}
			});
	})
