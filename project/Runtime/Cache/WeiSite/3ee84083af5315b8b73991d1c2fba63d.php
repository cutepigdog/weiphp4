...
<div class="span9 page_message">
	<section id="contents">
      <div class="setting_step app_setting content_step" style="margin-top:20px;">
         <a class="step step_cur_1" href="<?php echo addons_url('WeiSite://Template/lists',array('mdm'=>I('mdm')));?>">1.选择列表模板</a>
       	 <a class="step " href="<?php echo addons_url('WeiSite://Template/detail',array('mdm'=>I('mdm')));?>">2.选择内容模板</a>
         <a class="step " href="<?php echo addons_url('WeiSite://Cms/lists',array('mdm'=>I('mdm')));?>">3.内容管理</a> 
         <a class="step " href="<?php echo addons_url('WeiSite://WeiSite/preview_cms',array('mdm'=>I('mdm')));?>">4.效果预览</a>
  </div>
