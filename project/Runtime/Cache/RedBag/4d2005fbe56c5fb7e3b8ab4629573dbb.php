  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        <li class=""><a href="<?php echo U('lists');?>">红包列表<b class="arrow fa fa-sort"></b></a></li>
        <li class="current"><a href="javascript:;">新增红包<b class="arrow fa fa-sort"></b></a></li>
      </ul>
        ...
        <form id="form" action="<?php echo ($post_url); ?>" method="post" class="form-horizontal form-center">
        	<ul id="tab" class="tab-pane in">
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>活动名称 <span class="check-tips">（如：猜灯谜抢红包活动）(不超过25个字)</span></label>
                    <div class="controls">
                      <input class="text input-large" name="act_name" value="" />
                    </div>
                  </li>   
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span> 提供方名称 </label>
                    <div class="controls">
                      <input type="text" class="text input-large" name="nick_name" value="">
                    </div>
                  </li>  
                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span> 商户名称  <span class="check-tips">（红包发送者名称）</span></label>
                    <div class="controls">
                      <input type="text" class="text input-large" name="send_name" value="">
                    </div>
                  </li>  
                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span> 红包总金额   <span class="check-tips">（付款金额，单位分）</span></label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="total_amount" value="1000">
                    </div>
                  </li>  
                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>  最小红包金额     <span class="check-tips">（付款金额，单位分）</span></label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="min_value" value="1000">
                    </div>
                  </li>  
                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>  最大红包金额     <span class="check-tips">（付款金额，单位分）</span></label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="max_value" value="1000">
                    </div>
                  </li>  
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>  红包发放总人数     </label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="total_num" value="1">
                    </div>
                  </li>  
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>  红包祝福语      <span class="check-tips">（如：感谢您参加猜灯谜活动，祝您元宵节快乐！不超过25个字）</span></label>
                    <div class="controls">
                      <input type="text" class="text input-large" name="wishing" value="">
                    </div>
                  </li>  
                 

                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>  每人最多领取次数       <span class="check-tips">（0 表示不限制）</span></label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="collect_limit" value="0">
                    </div>
                  </li> 
                   <li class="form-item cf">
                    <label class="item-label"> 活动备注</label>
                    <div class="controls">
                      <input type="text" class="text input-large" name="act_remark" value="">
                    </div>
                  </li>                   
            </ul>
