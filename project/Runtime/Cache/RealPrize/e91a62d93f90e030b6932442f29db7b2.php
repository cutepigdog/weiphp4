  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        <li class=""><a href="<?php echo U('lists');?>">实物奖励列表<b class="arrow fa fa-sort"></b></a></li>
        	...
        	<ul id="tab" class="tab-pane in">
            	 <li class="form-item cf">
                  ...
                  <li class="form-item cf toggle-prize_type">
              			...
              			<div class="controls">
                			<?php $_result=parse_field_attr($fields['prize_type']['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="check-item">
								  <input type="radio" class="regular-radio toggle-data" value="<?php echo ($key); ?>" id="prize_type_<?php echo ($key); ?>" name="prize_type" toggle-data="<?php echo (get_hide_attr($vo)); ?>" />
								  <label for="prize_type_<?php echo ($key); ?>"></label><?php echo (clean_hide_attr($vo)); ?> 
