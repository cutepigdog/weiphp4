...
<div id="main-content">
  ...
  <div id="main" class="main">
	...
	<div class="main-title cf">
		<h2><?php echo ($info['id']?'编辑':'新增'); ?> [<?php echo ($model['title']); ?>] 属性 : <a href="<?php echo U('index','model_id='.$model['id']);?>">返回列表</a></h2>
	</div>
                ...
                <div id="tab2" class="tab-pane tab2">
					...
					<div id='file_check'>
						<div class="form-item cf">
							...
							<div class="controls">
								<input type="text" class="text input-large" name="validate_file_exts" value="<?php echo ($info["validate_file_exts"]); ?>">
							</div>
						</div>
						<div class="form-item cf">
							<label class="item-label">验证上传文件大小<span class="check-tips">（上传文件大小最大值，单位为字节）</span></label>
							<div class="controls">
								<input type="text" class="text input-large" name="validate_file_size" value="<?php echo ($info["validate_file_size"]); ?>">
							</div>
						</div>
					</div>
				</div>
