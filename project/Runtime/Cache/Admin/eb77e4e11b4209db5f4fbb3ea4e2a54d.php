...
<div id="main-content">
  ...
  <div id="main" class="main">
	...
	<div class="cf">
		<div class="fl">
			<div class="tools">
				<?php $add_url = U('add',array('place'=>$_GET['place'])); ?><a class="btn" href="<?php echo ($add_url); ?>">新 增</a>
				<?php $del_url = U('del',array('place'=>$_GET['place'])); ?><button class="btn ajax-post confirm" target-form="ids" url="<?php echo ($del_url); ?>">删 除</button>
			</div>
		</div>
