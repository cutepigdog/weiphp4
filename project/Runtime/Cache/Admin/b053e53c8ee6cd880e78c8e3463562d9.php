...
<div class="tab-wrap">
    ...
    <!-- 表单 -->
    <form id='form' action='http://weiphp.bb/index.php?s=/w0/Admin/Menu/add.html' method='post' class='form-horizontal form-center'><div class='form-item cf toggle-menu_type '>
			<label class='item-label'>菜单类型</label>
			<div class='controls'><select name='menu_type'><option value='0' class='toggle-data' toggle-data='pid@hide' selected >顶级菜单</option><option value='1' class='toggle-data' toggle-data='pid@show'>侧栏菜单</option></select></div></div>
<div class='form-item cf toggle-pid '>
			<label class='item-label'>上级菜单</label>
			<div class='controls'><div id='cascade_pid'></div><?php echo hook ( 'cascade', ['name' => 'pid', 'value' => '', 'extra' => 'type=db&table=menu&menu_type=0&uid=[manager_id]&place=0'] );?></div></div>
...
<div class='form-item cf toggle-sort '>
			...
			<div class='controls'><input type='number' class='text' name='sort' value=''></div></div>
<input type='hidden' name='place' value='' />
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1541995229' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1541995229' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1541995229' charset='UTF-8'></script> 
