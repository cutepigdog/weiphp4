...
(function(){
  ...
  $(function(){
   ...
   var _id =$('#nid').find('input').val();
	function addPost(){
		var $postHtml = $('<div class="chooseShopDialog"><ul><center><img src="/Public/Home/images/loading.gif"/></center></ul><br/><div class="m15"><a href="javascript:;" class="btn" id="confirmBtn">确定</a></div></div>');
