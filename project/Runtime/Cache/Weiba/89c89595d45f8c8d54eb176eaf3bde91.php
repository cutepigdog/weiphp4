...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://weiphp.bb/index.php?s=/w16/Weiba/Post/add/mdm/358%7C361.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-weiba_id '>
			<label class='item-label'>所属版块</label>
			<div class='controls'><div id='dynamic_select_weiba_id'></div><?php echo hook ( 'dynamic_select', ['name' => 'weiba_id', 'value' => '', 'extra' => 'table=weiba&value_field=id&title_field=weiba_name'] );?></div></div>
<div class='form-item cf toggle-title '>
			<label class='item-label'><span class='need_flag'>*</span>帖子标题</label>
			<div class='controls'><input type='text' class='text input-large' name='title' value=''></div></div>
<div class='form-item cf toggle-content '>
			<label class='item-label'><span class='need_flag'>*</span>帖子内容</label>
			<div class='controls'><label class='textarea'><textarea name='content' style='width:405px;height:100px;'></textarea><?php echo hook ( 'adminArticleEdit', [ 'name' => 'content', 'value' => '' ] );?>  </label></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542000931' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542000931' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542000931' charset='UTF-8'></script> 
  <script type='text/javascript'>
