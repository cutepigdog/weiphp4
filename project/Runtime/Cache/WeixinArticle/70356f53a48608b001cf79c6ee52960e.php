...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
        <form id='form' action='http://weiphp.bb/index.php?s=/w16/WeixinArticle/WeixinArticle/edit.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-article_title '>
			<label class='item-label'><span class='need_flag'>*</span>标题</label>
			<div class='controls'><input type='text' class='text input-large' name='article_title' value='美副国安顾问米拉·里卡德尔将被开除，第一夫人称其不配'></div></div>
<div class='form-item cf toggle-type '>
			<label class='item-label'>文章类别</label>
			<div class='controls'><div id='dynamic_select_type'></div><?php echo hook ( 'dynamic_select', ['name' => 'type', 'value' => '3', 'extra' => 'table=weixin_category&value_field=id&title_field=category_name'] );?></div></div>
<div class='form-item cf toggle-article_content '>
			<label class='item-label'><span class='need_flag'>*</span>内容</label>
			<div class='controls'><label class='textarea'><textarea name='article_content' style='width:405px;height:100px;'><p>白宫又有人要离职？美国有线电视新闻网(CNN)11月13日援引白宫官员的话称，副国家安全顾问米拉·里卡德尔将被开除，但正式离开时间尚不可知。</p><p>这一次，不仅是特朗普要炒了她，第一夫人也点名要其走人。当地时间13日，第一夫人办公室发表声明要求炒了里卡德尔，“第一夫人认为她不配在白宫服务。”</p><p>究其原因，《华尔街日报》13日援引匿名消息人士报道称，里卡德尔在梅拉尼娅非洲行期间的飞机上与第一夫人团队成员发生争执，且她被认为是一些有关梅拉尼娅及其员工负面报道的消息来源。</p><p><br/></p></textarea><?php echo hook ( 'adminArticleEdit', [ 'name' => 'article_content', 'value' => '' ] );?>  </label></div></div>
<input type='hidden' name='id' value='6' />
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542171428' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542171428' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542171428' charset='UTF-8'></script> 
  <script type='text/javascript'>
