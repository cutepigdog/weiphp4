...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://weiphp.bb/index.php?s=/w16/WeixinArticle/WeixinArticle/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-article_title '>
			<label class='item-label'><span class='need_flag'>*</span>标题</label>
			<div class='controls'><input type='text' class='text input-large' name='article_title' value=''></div></div>
<div class='form-item cf toggle-type '>
			<label class='item-label'>文章类别</label>
			<div class='controls'><div id='dynamic_select_type'></div><?php echo hook ( 'dynamic_select', ['name' => 'type', 'value' => '', 'extra' => 'table=weixin_category&value_field=id&title_field=category_name'] );?></div></div>
<div class='form-item cf toggle-article_content '>
			<label class='item-label'><span class='need_flag'>*</span>内容</label>
			<div class='controls'><label class='textarea'><textarea name='article_content' style='width:405px;height:100px;'></textarea><?php echo hook ( 'adminArticleEdit', [ 'name' => 'article_content', 'value' => '' ] );?>  </label></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1542171396' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1542171396' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1542171396' charset='UTF-8'></script> 
  <script type='text/javascript'>
