<?php if (!defined('THINK_PATH')) exit(); switch($addons_config["editor_type"]): case "1": ?>
	...
	<?php case "2": ?>
		<input type="hidden" name="parse" value="0">
		<?php if(($addons_config["editor_wysiwyg"]) == "1"): ?><link rel="stylesheet" href="/Public/static/kindeditor/default/default.css?v=<?php echo SITE_VERSION;?>" />
			<script charset="utf-8" src="/Public/static/kindeditor/kindeditor-min.js"></script>
			<script charset="utf-8" src="/Public/static/kindeditor/zh_CN.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript">
				...
				KindEditor.ready(function(K) {
					editor_<?php echo ($addons_data["name"]); ?> = K.create('textarea[name="<?php echo ($addons_data["name"]); ?>"]', {
						...
						uploadJson : '<?php echo U("Home/EditorUpload/ue_upimg");?>',
		...
		<?php else: ?>
			...
			<script type="text/javascript" charset="utf-8" src="/Public/static/<?php echo ($driver_file); ?>/ueditor.config.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/Public/static/<?php echo ($driver_file); ?>/ueditor.all.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/Public/static/<?php echo ($driver_file); ?>/lang/zh-cn/zh-cn.js?v=<?php echo SITE_VERSION;?>"></script>
         
			<script type="text/javascript">
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				window.UEDITOR_HOME_URL = "/Public/static/<?php echo ($driver_file); ?>";
				...
				window.UEDITOR_CONFIG.imageUrl = '<?php echo U("Home/EditorUpload/ue_upimg");?>';
				window.UEDITOR_CONFIG.imagePath = '';
				window.UEDITOR_CONFIG.imageFieldName = 'imgFile';
				//在这里扫描图片
				window.UEDITOR_CONFIG.imageManagerUrl='<?php echo U("Home/EditorUpload/ue_mgimg");?>';//图片在线管理的处理地址
            ...
            <script type="text/javascript" charset="utf-8" src="/Public/static/<?php echo ($driver_file); ?>/h5/main.js?v=<?php echo SITE_VERSION;?>"></script><?php endif; break;?>
	<?php case "3": ?>
		...
		<script charset="utf-8" src="/Public/static/xheditor/xheditor_lang/zh-cn.js?v=<?php echo SITE_VERSION;?>"></script>
		<script type="text/javascript" src="/Public/static/xheditor/xheditor_plugins/ubb.js?v=<?php echo SITE_VERSION;?>"></script>
		<script type="text/javascript">
	...
	<?php case "4": ?>
		<link rel="stylesheet" href="/Public/static/thinkeditor/skin/default/style.css?v=<?php echo SITE_VERSION;?>" />
		<script type="text/javascript" src="/Public/static/jquery-migrate-1.2.1.min.js"></script>
		<script type="text/javascript" src="/Public/static/thinkeditor/jquery.thinkeditor.js?v=<?php echo SITE_VERSION;?>"></script>
		<script type="text/javascript">
			$(function(){
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				var options = {
